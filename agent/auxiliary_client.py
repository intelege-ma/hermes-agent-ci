    ...
    *,
    ...
    try:
        ...
        if should_fallback and (is_auto or is_capacity_error):
            ...
            # Layer 1: Walk main fallback_providers chain
            ...
            # Layer 2: Per-task fallback_chain (explicit-provider users)
            ...
            # Layer 3: Main agent model safety net
            ...
            # Layer 4: Legacy payment fallback
            ...
            # All fallback layers exhausted
            logger.warning(
                "Auxiliary %s: %s on %s and all fallbacks exhausted "
                "(fallback_providers + fallback_chain + main agent model + payment fallback). "
